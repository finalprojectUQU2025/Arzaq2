...
class Messages
{
    private static $arMessages = [
        ...
        'ERROR_CREATE' => 'فشل في عملية إنشاء يوجد حساب بهذا الاسم يرجى تحديث البيانات',
        ...
        'BLOCK_ACCOUNT' => 'لقد تم حظر حسابك، يرجى الاتصال بالدعم',
        ...
        'PERMISSIONREADEEROOR' => 'عذرا ليس لديك الصلاحيات في الوصول الى هذة البيانات',
    ...
    private static $enMessages = [
        ...
        'ERROR_CREATE' => 'Failed to create an account with this name. Please update the data',
        ...
        'BLOCK_ACCOUNT' => 'Your account has been banned, please contact support',
        ...
        'PERMISSIONREADEEROOR' => 'Sorry, you do not have permission to access this data',
