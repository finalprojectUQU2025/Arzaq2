                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="brand-text font-weight-light">تعديل مدينة {{ $country->name ?? '' }}</h3>
                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"id="name" name="name"
                                                    placeholder="إسم المدينة ..." value="{{ $country->name ?? '' }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file-upload">
                                                    ...
                                                    <span class="file-label" style="text-align: right;"
                                                        id="fileName">{{ $country->image ?? '' }}</span>
                                                </div>
                                            </div>
                                        </div> --}}
...
@section('script')
    ...
    <script>
        ...
        function performstore() {
            ...
            axios.post('/cms/admin/countries/' + id, formData)
