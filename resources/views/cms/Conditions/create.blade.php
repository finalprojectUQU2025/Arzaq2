                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="brand-text font-weight-light">إضافة شرط جديدة الى النظام</h3>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" id="sub_title" name="sub_title" placeholder="تفاصيل الشرط ..."></textarea>
                                            </div>
                                        </div>
...
@section('script')
    <script>
        function performstore() {
            ...
            axios.post('/cms/admin/conditions', formData)
